...
export default function RefundCancellationPage() {
  return (
    <LegalPageLayout
      ...
      intro="How cancellations, refunds, and disputes actually work on WorkBridge's escrow system — including what happens before and after a project is funded."
    >
      <LegalSection id="overview" title="1. Overview">
        <p>
          WorkBridge holds a Business's project budget in Escrow once it's verified as funded, and only releases it
          to the Worker once the Business approves the delivered work. This page explains what happens to that
          money if a project is cancelled at any stage, instead.
        </p>
      </LegalSection>

      <LegalSection id="before-funding" title="2. Cancellation Before Funds Are Secured">
        <p>
          Before a Business funds Escrow, no money has moved — cancelling an invite, application, or an accepted
      ...
      <LegalSection id="momentum-shield" title="4. Momentum Shield">
        <p>
          ...
          project while the shield lasts. It does not block a formally raised dispute (Section 5) — it only prevents
          the instant, no-review cancellation path.
        </p>
      </LegalSection>
      ...
      <LegalSection id="disputes" title="5. Dispute Resolution & Refunds">
        <p>
          ...
          affecting Escrowed funds, either party can raise a dispute directly from the project. This freezes the held
          funds immediately — neither an automatic refund nor an automatic release happens at this point.
        </p>
        <p>
          A WorkBridge admin then reviews both sides' account of what happened and makes a real, human decision:
          either releasing the funds to the Worker or refunding them to the Business. There is no fixed turnaround
          time we guarantee today, since every dispute is reviewed individually rather than resolved by a formula.
        </p>
      </LegalSection>
      ...
      <LegalSection id="payment-gateway-note" title="8. A Note on Live Payments">
        <p>
          ...
          automated payment gateway — every Escrow deposit and Worker payout today is manually verified and
          processed by our team, not moved automatically by a card or bank network. This page describes the real
          rules those manual refunds and releases follow; it will be updated the moment automated payment
