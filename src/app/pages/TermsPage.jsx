  ...
  return (
    ...
    >
      <LegalSection id="acceptance" title="1. Acceptance & Eligibility">
        <p>By creating a WorkBridge account, you agree to these Terms and our Privacy Policy. You must be at least 18 years old and provide accurate account information. You're responsible for all activity that happens under your account.</p>
      </LegalSection>

      <LegalSection id="definitions" title="2. Definitions">
        <ul>
          <li><strong>Platform</strong> — the WorkBridge website, applications, and services collectively.</li>
          ...
          <li><strong>Escrow</strong> — the held state of a Project's budget from verified funding until the work is approved and released.</li>
        </ul>
      </LegalSection>

      <LegalSection id="user-obligations" title="3. User Obligations">
        <h3>3.1 Businesses</h3>
        <p>A Business may post Projects to the open board or invite a specific Worker directly. A Business account must complete our admin-reviewed verification flow before it can post jobs. A Business agrees to fund Escrow in good faith and to review submitted work in a timely manner.</p>
      ...
      <LegalSection id="how-a-project-works" title="4. How a Project Works">
        <ul>
          ...
          <li>Once accepted, the Business funds the Project — the budget is verified and marked as secured in Escrow before work begins.</li>
      ...
      <LegalSection id="preview-features" title="11. Features Shown As Preview">
        <p>Some parts of WorkBridge — like the Billing & Subscriptions section in Settings, or the Company Page's activity stats — are shown as an honestly-labeled preview of what we're building toward. They are not currently active, charged, or backed by live data unless explicitly stated otherwise on the page itself.</p>
      </LegalSection>
      ...
      <LegalSection id="governing-law" title="15. Governing Law & Disputes">
        <p>WorkBridge Technologies Pvt. Ltd. is an Indian company, and these Terms are governed by the laws of India. Any dispute arising out of your use of the Platform that cannot be resolved directly through our Support team will be subject to the exclusive jurisdiction of the courts of India.</p>
      </LegalSection>
