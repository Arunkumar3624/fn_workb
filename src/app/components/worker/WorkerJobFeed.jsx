      ...
      <section className="relative mx-auto max-w-6xl px-6 py-8">
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-white/70 bg-white/60 backdrop-blur-xl p-10 text-center shadow-lg shadow-slate-200/40">
            ...
            <h2 className="mt-4 text-lg font-bold text-slate-900">Nothing open right now</h2>
            <p className="mt-1 text-sm text-slate-500">Check back soon — new jobs land here the moment a business posts one.</p>
          </div>
        ) : (
