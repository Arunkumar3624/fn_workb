...
export default function WorkerJobFeed() {
  ...
  return (
    <div className="wb-scroll-clean relative h-full min-h-0 overflow-y-auto bg-gradient-to-br from-[#dbe4ff] via-[#eef1ff] to-[#ffe4d2] pb-20 text-slate-900 dark:text-white dark:from-slate-950 dark:via-slate-950 dark:to-slate-950">
