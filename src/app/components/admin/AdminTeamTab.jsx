    ...
    <div className="p-7">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full rounded-xl border-l-4 px-4 py-3 text-left transition-all ${
                        isSelected
                          ? "border-[#FF6B35] bg-slate-50 shadow-inner"
          ...
          <div className="lg:col-span-2">
            {selectedMember ? (
              <div>
                ...
                <div className="mb-4 rounded-2xl border border-red-200 bg-white p-6 shadow-sm">
                ...
                {selectedMember.role !== "Super Admin" && (
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-2xl border border-red-200 bg-white px-5 py-3 text-sm font-bold text-red-600 transition-colors hover:bg-red-50"
                  >
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm animate-in fade-in duration-300">
          <form onSubmit={handleAddMember} className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl animate-in zoom-in-95">
