      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {items.map((w) => {
            ...
            return (
              <div key={w.id} className="rounded-xl border border-white/70 bg-white/60 p-5 shadow-lg shadow-slate-200/40 backdrop-blur-xl">
                <div className="mb-4 flex items-start justify-between gap-4">
                  ...
                  <div className="flex-shrink-0 text-right">
                    ...
                    <div className="mt-0.5 text-xs text-amber-600">Debited, Awaiting Transfer</div>
                  </div>
                </div>

                <div className="mb-4 rounded-lg bg-slate-50 px-3 py-2.5 font-mono text-xs text-slate-600">
                  <span className="font-bold text-slate-800">{w.payout_method === "UPI" ? "UPI" : "Bank Transfer"}:</span> {w.payout_details}
                </div>
