                ...
                {resolved ? (
                  ...
                  <div className="space-y-2.5">
                    <textarea
                      ...
                      rows={3}
                      className="w-full rounded-lg border border-slate-200 px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-violet-200"
                    />
                    <button
                      onClick={() => handleResolve(r.id)}
                      disabled={busyId === r.id}
                      className="flex items-center gap-1.5 rounded-lg border border-violet-200 bg-violet-50 px-4 py-2 text-xs font-semibold text-violet-700 transition-colors hover:bg-violet-100 disabled:opacity-60"
                    >
