          ...
          <table className="w-full border-separate border-spacing-y-3 px-3">
            ...
            <tbody>
              {ADMIN_TRANSACTIONS.map((txn) => {
                ...
                return (
                  <tr key={txn.id} className="bg-white shadow-sm border border-slate-100 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-md">
                    ...
                    <td className="px-5 py-4 rounded-r-xl">
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-slate-600 hover:bg-slate-100 transition-colors w-fit"
                      >
